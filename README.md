...
1. **Background study**: vengono inizialmente studiati e valutati il sistema esistente e il dominio dell'applicazione. In particolare i punti che si vogliono approfondire attraverso questa attività sono la comprensione dei servizi attualmente offerti dall'università e di chi li fornisce (come per esempio le segreterie online <!-- non so come scriverlo: ma è interessante capire il modo in cui potremo andare a chiedere informazioni per esempio per scaricare piano di studio e potersi iscrivere agli esami -->). Inoltre si andranno ad identificare le applicazioni già sviluppate e le features offerte, da cui poter estrarre informazioni utili<!--questo va rivisto -->.
